...
class PasswordManager():
    ...
    def get_for_service(self, service_name):
        if service_name in self.password_dictionary:
            return self.password_dictionary[service_name]
    def list_services(self):
        list_of_services = []
        for service in self.password_dictionary:
            if self.password_dictionary[service] != None:
